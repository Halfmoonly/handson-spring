package org.lyflexi.frameworktest.controller;
...
import org.lyflexi.frameworktest.service.IAction;
import org.lyflexi.frameworktest.service.UserService;
...
//    }
    ...
    public User doTest8(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("userService.getUserInfo(userid)=" + user);
        return user;
    }
